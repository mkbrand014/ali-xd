...
os.system('xdg-open http://wa.me/+923215749976')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=murtazaali.murtazaali.56884')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
888       888  "Y88888P"  888   T88b    888  d88P     888 d8888888888 d88P     888 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+923215749976?text=MR murtaza💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=murtazaali.murtazaali.56884');riaz()
	if riaz1 =='2':
		bangla()
	else:
